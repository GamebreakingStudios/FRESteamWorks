...
package com.amanitadesign.steam {
	...
	public class FRESteamWorks extends EventDispatcher implements ISteamWorks {
		...
		public function inputInit():Boolean {
		    if(!callWrapper(AIRSteam_InputInit, [])) return false;
			return readBoolResponse;
		}
		public function getControllerForGamepadIndex(index:int):String {
			if(!callWrapper(AIRSteam_GetControllerForGamepadIndex, [index])) return "0";
            return readStringResponse();
		}
		public function showBindingPanel(inputHandle:String):Boolean {
            if(!callWrapper(AIRSteam_ShowBindingPanel, [inputHandle])) return false;
            return readBoolResponse;
		}
		public function getActionSetHandle(actionSetName:String):String {
			if(!callWrapper(AIRSteam_GetActionSetHandle, [actionSetName])) return "0";
            return readStringResponse();
		}
		public function getDigitalActionHandle(actionName:String):String {
			if(!callWrapper(AIRSteam_GetDigitalActionHandle, [actionName])) return "0";
            return readStringResponse();
		}
		public function getAnalogActionHandle(actionName:String):String {
			if(!callWrapper(AIRSteam_GetAnalogActionHandle, [actionName])) return "0";
            return readStringResponse();
		}
		public function getDigitalActionData(inputHandle:String, actionHandle:String):InputDigitalActionData {
			if(!callWrapper(AIRSteam_GetDigitalActionData, [inputHandle, actionHandle])) return null;
			return readResponse() as InputDigitalActionData;
		}
		public function getAnalogActionData(inputHandle:String, actionHandle:String):InputAnalogActionData {
			if(!callWrapper(AIRSteam_GetAnalogActionData, [inputHandle, actionHandle])) return null;
			return readResponse() as InputAnalogActionData;
		}
		public function runFrame():Boolean {
            if(!callWrapper(AIRSteam_RunFrame, [])) return false;
            return readBoolResponse;
		}
		public function getConnectedControllers():Array {
			if(!callWrapper(AIRSteam_GetConnectedControllers, [])) return [];
			return readResponse() as Array;
		}
		public function activateActionSet(inputHandle:String, actionSetHandle:String):Boolean {
            if(!callWrapper(AIRSteam_ActivateActionSet, [inputHandle, actionSetHandle])) return false;
            return readBoolResponse;		
		}
		public function getHandleAllControllers():String {
			if(!callWrapper(AIRSteam_GetHandleAllControllers, [])) return "0";
            return readStringResponse();
		}
		public function getDigitalActionOrigins(inputHandle:String, actionSetHandle:String, digitalActionHandle:String):Array {
			if(!callWrapper(AIRSteam_GetDigitalActionOrigins, [inputHandle, actionSetHandle, digitalActionHandle])) return [];
			return readResponse() as Array;
		}
		public function getAnalogActionOrigins(inputHandle:String, actionSetHandle:String, analogActionHandle:String):Array {
			if(!callWrapper(AIRSteam_GetAnalogActionOrigins, [inputHandle, actionSetHandle, analogActionHandle])) return [];
			return readResponse() as Array;
		}
		...
		public function getStringForActionOrigin(eOrigin:String):String {
            if(!callWrapper(AIRSteam_GetStringForActionOrigin, [eOrigin])) return "";
            return readStringResponse();
		}
		public function showGamepadTextInput(eInputMode:int, eLineInputMode:int, pchDescription:String, unCharMax:int, pchExistingText:String):Boolean {
            if(!callWrapper(AIRSteam_ShowGamepadTextInput, [eInputMode, eLineInputMode, pchDescription, unCharMax, pchExistingText])) return false;
            return readBoolResponse;		
		}
		public function showFloatingGamepadTextInput(eKeyboardMode:int, nTextFieldXPosition:int, nTextFieldYPosition:int, nTextFieldWidth:int, nTextFieldHeight:int):Boolean {
            if(!callWrapper(AIRSteam_ShowFloatingGamepadTextInput, [eKeyboardMode, nTextFieldXPosition, nTextFieldYPosition, nTextFieldWidth, nTextFieldHeight])) return false;
            return readBoolResponse;		
        }
		public function steamInputShutdown():Boolean {
            if(!callWrapper(AIRSteam_SteamInputShutDown, [])) return false;
            return readBoolResponse;		
		}
		public function dismissFloatingGamepadTextInput():Boolean {
            if(!callWrapper(AIRSteam_DismissFloatingGamepadTextInput, [])) return false;
            return readBoolResponse;		
		}
		// END GENERATED CODE
	}
