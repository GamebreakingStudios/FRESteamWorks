...
std::string AIRSteam_GetAchievementDisplayAttribute();
std::string AIRSteam_GetAchievementName();
Image AIRSteam_GetAchievementIcon();
uint32 AIRSteam_GetNumAchievements()
